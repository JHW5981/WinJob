...
from configuration_aceread2 import AceRead2Config, AceRead2VisionConfig
...
class Qwen2_5_VisionTransformerPretrainedModel(Qwen2_5_VLPreTrainedModel):
    config_class = AceRead2VisionConfig
...
class Qwen2_5_VLRotaryEmbedding(nn.Module):
    def __init__(self, config: AceRead2Config, device=None):
        super().__init__()
...
class Qwen2_5_VLAttention(nn.Module):
    ...
    def __init__(self, config: AceRead2Config, layer_idx: Optional[int] = None):
        super().__init__()
        self.config = config
...
class Qwen2_5_VLDecoderLayer(nn.Module):
    def __init__(self, config: AceRead2Config, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size
...
class Qwen2_5_VLModel(Qwen2_5_VLPreTrainedModel):
    def __init__(self, config: AceRead2Config):
...
__all__ = ["AceRead2ForConditionalGeneration", "Qwen2_5_VLModel", "Qwen2_5_VLPreTrainedModel"]


if __name__ == "__main__":
    from configuration_aceread2 import AceRead2Config
    ...
    messages = [
        {
            ...
            "content": [
                {
                    "type": "image",
                    "image": "/home/jihuawei2/projects/WinJob/dustbin/34608.jpg",
                },
