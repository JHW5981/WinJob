...
from .merger_part import Qwen2_5_VLPatchMerger
...
if __name__ == '__main__':
    config = AceRead2VisionConfig.from_pretrained('/home/jihuawei2/projects/WinJob/pretrained_weight/Qwen2.5-VL-3B-Instruct')
    print(config)
    ...
    results = vision_model(inputs['pixel_values'], inputs['image_grid_thw'])
    print(results.shape)
